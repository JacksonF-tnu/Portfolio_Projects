...
template <> constexpr inline auto ConnectionWidget::qt_create_metaobjectdata<qt_meta_tag_ZN16ConnectionWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SlotData<void(QTreeWidgetItem *)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 10 },
        }}),
        // Slot 'onCurrentItemChanged'
        QtMocHelpers::SlotData<void(QTreeWidgetItem *)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 9, 12 },
        }}),
    };
...
void ConnectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ConnectionWidget::*)(const QString & )>(_a, &ConnectionWidget::tableActivated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ConnectionWidget::*)(const QString & )>(_a, &ConnectionWidget::metaDataRequested, 1))
            return;
    }
}
